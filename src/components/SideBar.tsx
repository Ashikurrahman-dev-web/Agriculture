...
import { Bug, Globe, Home, Menu, MessageCircle, Settings, Sprout, TestTube2, X } from 'lucide-react';
...
fixed inset-y-0 left-0 z-40 w-1/2 min-w-[220px] lg:w-64 border-r border-[#2F5943] text-black p-5 flex flex-col justify-between
      ...
      >
        <div>
  <div className="flex items-center gap-3 px-2 py-4 mb-4 mt-3 border-b border-[#2F5943]">
           <div
